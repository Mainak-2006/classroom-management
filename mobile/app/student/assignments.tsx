  ...
  return (
    <Screen>
      ...
      >
        ...
        <Text className="mt-0.5 text-xs text-slate-500">View your course assignments & deadlines</Text>
        ...
        {loading ? (
          ...
          <View className="mt-20 items-center">
            <Text className="text-sm text-slate-500">
              You are not enrolled in any courses yet. Assignments will appear here once you are
              enrolled.
            </Text>
          </View>
        ) : (
                ...
                {filteredAssignments.map((assignment) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <Text className="mt-2 text-base font-bold text-slate-900">{assignment.title}</Text>
