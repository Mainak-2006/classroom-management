...
describe('StudentController', () => {
  ...
  describe('myAttendance', () => {
    it('should delegate to attendance for the current user', async () => {
      ...
      expect(attendanceService.findByStudent).toHaveBeenCalledWith(
        'student-1',
        currentUser,
      );
    });
  ...
  describe('myExams', () => {
    it('should delegate to the exam service for the current user', async () => {
      ...
      expect(examService.findByStudent).toHaveBeenCalledWith(
        'student-1',
        currentUser,
      );
    });
  ...
  describe('myAssignments', () => {
    it('should delegate to the assignment service for the current user', async () => {
      ...
      expect(assignmentService.findByStudent).toHaveBeenCalledWith(
        'student-1',
        currentUser,
      );
    });
