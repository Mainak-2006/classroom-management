...
import { CreateAttendanceManyDto } from './dto/create-attendance-many.dto';
...
export class AttendanceController {
  ...
  @Post('bulk')
  createBulk(
    @Body() dto: CreateAttendanceManyDto,
    @CurrentUser() user: AuthenticatedUser,
  ) {
    return this.attendanceService.createBulk(dto.items, user);
  }
